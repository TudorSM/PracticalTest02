...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serverPortEditText = (EditText)findViewById(R.id.editText3);
        connectButton = (Button)findViewById(R.id.button2);
        connectButton.setOnClickListener(connectButtonClickListener);

        clientAddressEditText = (EditText)findViewById(R.id.editText);
        clientPortEditText = (EditText)findViewById(R.id.editText2);
        informationTypeSpinner = (Spinner)findViewById(R.id.spinner2);
        getWeatherForecastButton = (Button)findViewById(R.id.button);
        getWeatherForecastButton.setOnClickListener(getWeatherForecastButtonClickListener);
        weatherForecastTextView = (TextView)findViewById(R.id.textView3);
    }
